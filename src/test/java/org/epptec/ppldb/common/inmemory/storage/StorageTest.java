...
class StorageTest {
    ...
    @Test
    void itCanStoreValue() throws NodeNotFoundException, InvalidIdentificationNumberException {
    ...
    @Test
    void itCanRemoveValueAndThrowExceptionWhenNodeNotFound() throws NodeNotFoundException, InvalidIdentificationNumberException {
        var identificationNumber = new Person.IdentificationNumber("9905059999");
        var storage = new PureStorage<Person.IdentificationNumber, Integer, String>(
            identifier -> identifier.toString().chars()
                .mapToObj(Character::getNumericValue)
